...
class Student:
    ...
    # Define the name and number when a student object is created, ex. student1 = Student('Maya', 133270231)
    ...
    def displayGPA(self):
        ...
        if len(self.courses) == 0:
            return 'GPA of student ' + self.name + ' is 0.0'  # Return GPA as 0 if no courses
